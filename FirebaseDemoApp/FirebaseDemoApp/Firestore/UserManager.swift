...
//    }
    ...
    func getAllUserFavoriteProducts(userId: String) async throws -> [UserFavouriteProduct] {
        try await userFavoriteProductCollection(userId: userId).getDocuments(as: UserFavouriteProduct.self)
    }
    ...
    func addListenerForAllUserFavoriteProducts(userId: String, completion: @escaping (_ products: [UserFavouriteProduct]) -> Void) {
...
//    func addListenerForAllUserFavoriteProducts(userId: String) -> AnyPublisher<[UserFavouriteProduct], any Error> {
